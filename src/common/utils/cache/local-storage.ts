// Unified handling of localStorage
...
// #region Currently applied theme name
...
export function setVisitedViews(views: TagView[]) {
  views.forEach((view) => {
    // Remove unnecessary properties to prevent JSON.stringify from handling circular references
    delete view.matched;
